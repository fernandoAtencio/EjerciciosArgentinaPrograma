...
console.log(
  "Tu salario mensual es " + calcularSalarioMensual(salarioAnual).toFixed(2)
);
console.log(
  "Tu salario semanal es " + calcularSalarioSemanal(salarioAnual).toFixed(2)
);
console.log(
  "Tu salario diario es " + calcularSalarioDiario(salarioAnual).toFixed(2)
);
